...
- The library API table (exports with signature and description) lives in `packages/htmlwasher/README.md`; the live-crawl-tester options live in `packages/live-crawl-tester/README.md`; the training workflow (dataset → `model.onnx` + `tfidf-vocab.json`) lives in `training/README.md`.
