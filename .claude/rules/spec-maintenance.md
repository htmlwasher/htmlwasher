...
- `trafilatura-alpha/SPEC.md` — the `trafilatura-alpha` library's public API and extraction/classification behavior
- `tools/live-crawl-tester/SPEC.md` — the live-site E2E fetcher (polite fetcher, cache, extraction over real URLs)
