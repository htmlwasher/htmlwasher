...
// brief's offline Phase 8 / Section 7 E2E deliverable is `tools/wash-corpus-tester/`
...
function main(): void {
  console.log(
    'live-crawl-tester: out-of-brief optional scaffold, not yet implemented (the offline E2E tester is tools/wash-corpus-tester/)',
  );
}
