...
// to the wire union the @trafilaturacore/native Rust core returns
...
import type { ExtractResult } from '@trafilaturacore/native';
...
describe('public PageType ↔ @trafilaturacore/native ExtractResult.pageType', () => {
