...
//! `trafilaturacore-native` — the Rust boilerplate-removal + page-type extraction core.
//!
...
//! classifier + confidence; the TypeScript layer owns the public `clean()` API,
...
//!   Rust sanitizes nothing else — the TS cleaning stage owns all tag/attribute/scheme
