...
use trafilaturacore_native::dom::{class_of, parse, tag_of};
use trafilaturacore_native::selector::content::find_content_node;
...
fn gutenberg_external_fixture_extracts_the_full_book() {
    ...
    let path = format!("{home}/r/trafilatura-external-tester/cache/3e2532c1eb86c33c.html");
