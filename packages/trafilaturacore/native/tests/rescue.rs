...
use trafilaturacore_native::{Options, PageType, extract};

fn content(input: &str, opts: &Options) -> trafilaturacore_native::ExtractResult {
...
fn antirez_external_fixture_recovers_the_post_body() {
    ...
    let path = format!("{home}/r/trafilatura-external-tester/cache/7857c13f48708eb1.html");
