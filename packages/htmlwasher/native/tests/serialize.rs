...
use htmlwasher_native::extract::{serialize_preserve, serialize_whitelist};
use htmlwasher_native::selector::discard::{is_always_excluded_name, is_boilerplate_named};
use htmlwasher_native::{CoreOptions, Options, PageType};
...
fn preserve_keeps_original_tags_and_all_attributes() {
    ...
    // preserve-markup, attributes SURVIVE (TS washing owns sanitization).
